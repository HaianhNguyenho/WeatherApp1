...
import com.example.appweather.WeatherList
import java.text.SimpleDateFormat
import java.util.*
// kết nối dữ liệu dự báo thời tiết với các view hiển thị trong RecyclerVie
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForeCastHolder {
        ...
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.upcomingforecardlist, parent, false)
...
//tham chiếu đến các thành phần giao diện dự báo thời tiết của RecyclerView
