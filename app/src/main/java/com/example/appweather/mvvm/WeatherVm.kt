package com.example.appweather.mvvm
...
class WeatherVm : ViewModel() {
    ...
    fun getWeather(city: String? = null) = viewModelScope.launch(Dispatchers.IO) {
        ...
        val sharedPrefs = SharePrefs.getInstance(context)
        ...
        val call = if (city != null) {
            RetroifitInstance.api.getWeatherByCity(city)
        } else {
            RetroifitInstance.api.getCurrentWeather(lat, lon)
        }
