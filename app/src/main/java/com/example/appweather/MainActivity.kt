...
import com.example.appweather.SharePrefs
import com.example.appweather.Utils
import com.example.appweather.Utils.Companion.PERMISSION_REQUEST_CODE
import com.example.appweather.WeatherActivity
import com.example.appweather.adapter.WeatherToday
import com.example.appweather.adapter.ForeCastAdapter
import com.example.appweather.databinding.ActivityMainBinding
import com.example.appweather.mvvm.WeatherVm
import com.example.appweather.service.RetroifitInstance
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPrefs = SharePrefs.getInstance(this@MainActivity)
